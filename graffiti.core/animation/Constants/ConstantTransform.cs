...
{
    public sealed class ConstantTransform: Transform
    {
        ...
        public static explicit operator ConstantTransform (Matrix value)
        {
            return new ConstantTransform { Transform = value };
        }
    }
}
